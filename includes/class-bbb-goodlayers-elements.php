...
class BBB_Goodlayers_Elements {
	...
	public function __construct() {
		...
		add_filter( 'gdlr_core_page_builder_module', array( $this, 'register_bracket_element' ) );
		add_filter( 'gdlr_core_page_builder_module', array( $this, 'register_table_element' ) );
	...
	public function register_shortcodes(): void {
		add_shortcode( 'gdlr_core_bbb_bracket', array( $this, 'render_bracket_shortcode' ) );
		add_shortcode( 'gdlr_core_bbb_table', array( $this, 'render_table_shortcode' ) );
	}
