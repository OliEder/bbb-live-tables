...
class BBB_Tables_Admin {
	...
	public function __construct() {
		...
		add_action( 'admin_post_bbb_tables_clear_cache', array( $this, 'handle_clear_cache' ) );
	}
	...
	private function render_club_tab(): void {
		...
		<?php else : ?>
			...
			<div class="card" style="max-width:700px; padding:15px; margin-top:15px;">
				<h2>Erkannte Teams <span style="font-size:.6em; font-weight:400; color:#888;">(<?php echo count( $teams ); ?> Teams · Club-ID: <?php echo (int) $club_id; ?>)</span></h2>
	...
	private function render_leagues_tab(): void {
		...
		<div class="card" style="max-width:950px; padding:15px;">
			<h2>Ligen & Turniere <span style="font-size:.6em; font-weight:400; color:#888;">(<?php echo count( $leagues ); ?> · Club-ID: <?php echo (int) $club_id; ?>)</span></h2>
			<p class="description" style="margin-bottom:12px;">
